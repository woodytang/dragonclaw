...
if /i "%1"=="update" (
    echo openclaw is managed by DragonClaw ^(bundled version^).
    echo.
    echo To update openclaw, update DragonClaw:
    echo   Open DragonClaw ^> Settings ^> Check for Updates
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\DragonClaw.exe" "%OPENCLAW_ENTRY%" %*
)
