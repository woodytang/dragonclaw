 ...
 * "openrouter.ai" carries the DragonClaw app-attribution headers.
 *
...
(function () {
  ...
  if (globalThis.__DragonClawFetchPatched) return;
  globalThis.__DragonClawFetchPatched = true;

  globalThis.fetch = function DragonClawFetch(input, init) {
    var url =
