...
interface PreinstalledMarker {
    source: 'DragonClaw-preinstalled';
    slug: string;
    version: string;
    installedAt: string;
}
...
/**
 * Built-in skills bundled with DragonClaw that should be pre-deployed to
...
const PREINSTALLED_MARKER_NAME = '.DragonClaw-preinstalled.json';
